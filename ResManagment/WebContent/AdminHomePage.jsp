				...
				<div class="table-title">
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<a href="#addBranch" class="btn btn-success" data-toggle="modal"><i
								class="material-icons">&#xE147;</i> <span>Add Branch</span></a> <a
								href="#deleteBranchModal" class="btn btn-danger"
						...
						<tr>
							...
							<c:forEach var="branche" items="${branchData}">
								<tr>
									...
									<td>${branche.branch}</td>
									<td><a href="DelBranchServlet?id=${branche.branchId}"
						...
						<div class="modal-body">
							...
							<div class="form-group">
								<label>User Name</label> <input type="text"
									name="managerUserName" class="form-control" required>
							</div>
							<div class="form-group">
		...
		<div id="deleteBranchModal" class="modal fade">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form action="DelBranchServlet " method="post">
						<div class="modal-header">
